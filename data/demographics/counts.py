...
with open(Path(__file__).resolve().parent / "spouse_presence_empirical_distributions.json", "w") as f:
...
with open(Path(__file__).resolve().parent / "children_count_empirical_distributions_married.json", "w") as f:
